...
public final class BufferedChannelKt {
    ...
    public static final long constructEBCompletedAndPauseFlag(long j4, boolean z3) {
        return (z3 ? EB_COMPLETED_PAUSE_EXPAND_BUFFERS_BIT : 0L) + j4;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long constructSendersAndCloseStatus(long j4, int i) {
        return (i << 60) + j4;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final <E> ChannelSegment<E> createSegment(long j4, ChannelSegment<E> channelSegment) {
    ...
    private static final long getEbCompletedCounter(long j4) {
        return j4 & 4611686018427387903L;
    }

    private static final boolean getEbPauseExpandBuffers(long j4) {
        return (j4 & EB_COMPLETED_PAUSE_EXPAND_BUFFERS_BIT) != 0;
    }

    private static final int getSendersCloseStatus(long j4) {
        return (int) (j4 >> 60);
    }

    private static final long getSendersCounter(long j4) {
        return j4 & SENDERS_COUNTER_MASK;
    }
