...
public abstract class Hilt_DeparturesFragment extends K implements GeneratedComponentManagerHolder {
    ...
    public Hilt_DeparturesFragment() {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((DeparturesFragment_GeneratedInjector) generatedComponent()).injectDeparturesFragment((DeparturesFragment) UnsafeCasts.unsafeCast(this));
    }
    ...
    public Hilt_DeparturesFragment(int i) {
        super(i);
        this.componentManagerLock = new Object();
        this.injected = false;
    }
