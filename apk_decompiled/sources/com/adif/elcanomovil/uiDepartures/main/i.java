...
public final class i extends SuspendLambda implements Function2 {
    ...
    public BottomNavFragmentDirections.Companion f4948a;
    ...
    public final /* synthetic */ DeparturesViewModel f4951d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(DeparturesViewModel departuresViewModel, Continuation continuation) {
        super(2, continuation);
        this.f4951d = departuresViewModel;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new i(this.f4951d, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i = this.f4950c;
        DeparturesViewModel departuresViewModel = this.f4951d;
        if (i == 0) {
            ...
            if ((invoke == null || invoke.length() == 0) && invoke2 != null && invoke2.length() != 0) {
                departuresViewModel.navigateToStations(invoke2, StationServiceType.SERVICES);
                return Unit.INSTANCE;
            }
            if ((invoke == null || invoke.length() == 0) && (invoke2 == null || invoke2.length() == 0)) {
            ...
            this.f4948a = companion2;
            this.f4949b = DeparturesFragment.bottomSheetToServicesTag;
            this.f4950c = 1;
            ...
            str = DeparturesFragment.bottomSheetToServicesTag;
        } else {
            if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            str = this.f4949b;
            companion = this.f4948a;
            ResultKt.throwOnFailure(obj);
        }
