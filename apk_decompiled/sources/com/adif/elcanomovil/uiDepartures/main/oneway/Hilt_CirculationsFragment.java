...
public abstract class Hilt_CirculationsFragment extends K implements GeneratedComponentManagerHolder {
    ...
    public Hilt_CirculationsFragment() {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((CirculationsFragment_GeneratedInjector) generatedComponent()).injectCirculationsFragment((CirculationsFragment) UnsafeCasts.unsafeCast(this));
    }
    ...
    public Hilt_CirculationsFragment(int i) {
        super(i);
        this.componentManagerLock = new Object();
        this.injected = false;
    }
