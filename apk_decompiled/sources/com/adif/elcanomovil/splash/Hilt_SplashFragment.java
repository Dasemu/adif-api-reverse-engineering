...
public abstract class Hilt_SplashFragment extends K implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((SplashFragment_GeneratedInjector) generatedComponent()).injectSplashFragment((SplashFragment) UnsafeCasts.unsafeCast(this));
    }
