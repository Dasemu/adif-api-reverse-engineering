...
public abstract class Hilt_SubscriptionHomeFragment extends K implements GeneratedComponentManagerHolder {
    ...
    public Hilt_SubscriptionHomeFragment() {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((SubscriptionHomeFragment_GeneratedInjector) generatedComponent()).injectSubscriptionHomeFragment((SubscriptionHomeFragment) UnsafeCasts.unsafeCast(this));
    }
    ...
    public Hilt_SubscriptionHomeFragment(int i) {
        super(i);
        this.componentManagerLock = new Object();
        this.injected = false;
    }
