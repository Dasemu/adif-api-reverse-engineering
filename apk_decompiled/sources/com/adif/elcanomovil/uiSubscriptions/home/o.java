...
public final class o extends Lambda implements Function0 {
    ...
    public final /* synthetic */ SubscriptionHomeViewModel f5385a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(SubscriptionHomeViewModel subscriptionHomeViewModel) {
        super(0);
        this.f5385a = subscriptionHomeViewModel;
    }
    ...
    public final Object invoke() {
        Context context;
        Context context2;
        SubscriptionHomeViewModel subscriptionHomeViewModel = this.f5385a;
        context = subscriptionHomeViewModel.context;
        String string = context.getString(R.string.stations_avisa_dialog_active);
        ...
        String string2 = context2.getString(R.string.stations_avisa_dialog_cancel);
