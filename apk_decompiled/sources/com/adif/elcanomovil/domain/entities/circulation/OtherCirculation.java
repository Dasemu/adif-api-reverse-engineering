...
public final /* data */ class OtherCirculation implements TrainCirculation {
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, d2 = {"Lcom/adif/elcanomovil/domain/entities/circulation/OtherCirculation$State;", "", "(Ljava/lang/String;I)V", "SUPPRESSED", "BOARDING", "DELAYED", "domain_proNon_corporateRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes.dex */
    ...
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\f\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0003¢\u0006\u0002\u0010\u0006J\t\u0010\u000b\u001a\u00020\u0003HÆ\u0003J\t\u0010\f\u001a\u00020\u0003HÆ\u0003J\t\u0010\r\u001a\u00020\u0003HÆ\u0003J'\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u0005\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\u000f\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0012\u001a\u00020\u0013HÖ\u0001J\t\u0010\u0014\u001a\u00020\u0003HÖ\u0001R\u0011\u0010\u0004\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0005\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\b¨\u0006\u0015"}, d2 = {"Lcom/adif/elcanomovil/domain/entities/circulation/OtherCirculation$Train;", "", NavArguments.ARG_DYNAMIC_LINKS_OPERATOR, "", NavArguments.ARG_DYNAMIC_LINKS_COMMERCIAL_NUMBER, NavArguments.ARG_DYNAMIC_LINKS_COMMERCIAL_PRODUCT, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "getCommercialNumber", "()Ljava/lang/String;", "getCommercialProduct", "getOperator", "component1", "component2", "component3", "copy", "equals", "", "other", "hashCode", "", "toString", "domain_proNon_corporateRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes.dex */
    ...
    public static /* synthetic */ OtherCirculation copy$default(OtherCirculation otherCirculation, Date date, String str, String str2, String str3, String str4, String str5, String str6, Train train, State state, String str7, boolean z3, boolean z4, String str8, boolean z5, boolean z6, boolean z7, TrainCirculationInfo trainCirculationInfo, String str9, boolean z8, String str10, String str11, String str12, String str13, String str14, String str15, String str16, int i, Object obj) {
        String str17;
        String str18;
        Date date2 = (i & 1) != 0 ? otherCirculation.date : date;
        String str19 = (i & 2) != 0 ? otherCirculation.time : str;
        String str20 = (i & 4) != 0 ? otherCirculation.delayedTime : str2;
        String str21 = (i & 8) != 0 ? otherCirculation.stationStepCode : str3;
        String str22 = (i & 16) != 0 ? otherCirculation.stationCode : str4;
        String str23 = (i & 32) != 0 ? otherCirculation.stationShortName : str5;
        String str24 = (i & 64) != 0 ? otherCirculation.stationLongName : str6;
        Train train2 = (i & 128) != 0 ? otherCirculation.train : train;
        State state2 = (i & 256) != 0 ? otherCirculation.state : state;
        String str25 = (i & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? otherCirculation.platform : str7;
        boolean z9 = (i & 1024) != 0 ? otherCirculation.platformWarning : z3;
        boolean z10 = (i & 2048) != 0 ? otherCirculation.platformMuted : z4;
        String str26 = (i & ConstantsKt.DEFAULT_BLOCK_SIZE) != 0 ? otherCirculation.observation : str8;
        boolean z11 = (i & 8192) != 0 ? otherCirculation.accessibleStation : z5;
        Date date3 = date2;
        boolean z12 = (i & 16384) != 0 ? otherCirculation.immediateDeparture : z6;
        boolean z13 = (i & 32768) != 0 ? otherCirculation.isShortTrain : z7;
        TrainCirculationInfo trainCirculationInfo2 = (i & 65536) != 0 ? otherCirculation.trainCirculation : trainCirculationInfo;
        String str27 = (i & 131072) != 0 ? otherCirculation.imageUrl : str9;
        boolean z14 = (i & 262144) != 0 ? otherCirculation.showExtended : z8;
        String str28 = (i & 524288) != 0 ? otherCirculation.operatorPlatform : str10;
        String str29 = (i & 1048576) != 0 ? otherCirculation.plannedPlatform : str11;
        String str30 = (i & 2097152) != 0 ? otherCirculation.sitraPlatform : str12;
        String str31 = (i & 4194304) != 0 ? otherCirculation.ctcPlatform : str13;
        String str32 = (i & 8388608) != 0 ? otherCirculation.technicalNumber : str14;
        String str33 = (i & 16777216) != 0 ? otherCirculation.resultantPlatform : str15;
        if ((i & 33554432) != 0) {
            str18 = str33;
            str17 = otherCirculation.preassignedPlatform;
        } else {
            str17 = str16;
            str18 = str33;
        }
        return otherCirculation.copy(date3, str19, str20, str21, str22, str23, str24, train2, state2, str25, z9, z10, str26, z11, z12, z13, trainCirculationInfo2, str27, z14, str28, str29, str30, str31, str32, str18, str17);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof OtherCirculation)) {
            return false;
        }
        OtherCirculation otherCirculation = (OtherCirculation) other;
        return Intrinsics.areEqual(this.date, otherCirculation.date) && Intrinsics.areEqual(this.time, otherCirculation.time) && Intrinsics.areEqual(this.delayedTime, otherCirculation.delayedTime) && Intrinsics.areEqual(this.stationStepCode, otherCirculation.stationStepCode) && Intrinsics.areEqual(this.stationCode, otherCirculation.stationCode) && Intrinsics.areEqual(this.stationShortName, otherCirculation.stationShortName) && Intrinsics.areEqual(this.stationLongName, otherCirculation.stationLongName) && Intrinsics.areEqual(this.train, otherCirculation.train) && this.state == otherCirculation.state && Intrinsics.areEqual(this.platform, otherCirculation.platform) && this.platformWarning == otherCirculation.platformWarning && this.platformMuted == otherCirculation.platformMuted && Intrinsics.areEqual(this.observation, otherCirculation.observation) && this.accessibleStation == otherCirculation.accessibleStation && this.immediateDeparture == otherCirculation.immediateDeparture && this.isShortTrain == otherCirculation.isShortTrain && Intrinsics.areEqual(this.trainCirculation, otherCirculation.trainCirculation) && Intrinsics.areEqual(this.imageUrl, otherCirculation.imageUrl) && this.showExtended == otherCirculation.showExtended && Intrinsics.areEqual(this.operatorPlatform, otherCirculation.operatorPlatform) && Intrinsics.areEqual(this.plannedPlatform, otherCirculation.plannedPlatform) && Intrinsics.areEqual(this.sitraPlatform, otherCirculation.sitraPlatform) && Intrinsics.areEqual(this.ctcPlatform, otherCirculation.ctcPlatform) && Intrinsics.areEqual(this.technicalNumber, otherCirculation.technicalNumber) && Intrinsics.areEqual(this.resultantPlatform, otherCirculation.resultantPlatform) && Intrinsics.areEqual(this.preassignedPlatform, otherCirculation.preassignedPlatform);
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("OtherCirculation(date=");
        sb.append(this.date);
        sb.append(", time=");
        sb.append(this.time);
    ...
    public /* synthetic */ OtherCirculation(Date date, String str, String str2, String str3, String str4, String str5, String str6, Train train, State state, String str7, boolean z3, boolean z4, String str8, boolean z5, boolean z6, boolean z7, TrainCirculationInfo trainCirculationInfo, String str9, boolean z8, String str10, String str11, String str12, String str13, String str14, String str15, String str16, int i, DefaultConstructorMarker defaultConstructorMarker) {
