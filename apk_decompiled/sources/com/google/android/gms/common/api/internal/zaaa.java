...
public final class zaaa implements zaca {
    ...
    /* JADX WARN: Type inference failed for: r15v1, types: [java.util.Map, s.j] */
    private zaaa(Context context, zabe zabeVar, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map map, Map map2, ClientSettings clientSettings, Api.AbstractClientBuilder abstractClientBuilder, Api.Client client, ArrayList arrayList, ArrayList arrayList2, Map map3, Map map4) {
        ...
        while (it.hasNext()) {
            jVar.put((Api.AnyClientKey) it.next(), this.zad);
        }
        Iterator it2 = map.keySet().iterator();
        while (it2.hasNext()) {
            jVar.put((Api.AnyClientKey) it2.next(), this.zae);
        }
        this.zaf = Collections.unmodifiableMap(jVar);
    }
    ...
    /* JADX WARN: Type inference failed for: r13v0, types: [java.util.Map, s.j] */
    /* JADX WARN: Type inference failed for: r14v0, types: [java.util.Map, s.j] */
    /* JADX WARN: Type inference failed for: r6v0, types: [java.util.Map, s.j] */
    /* JADX WARN: Type inference failed for: r7v0, types: [java.util.Map, s.j] */
    public static zaaa zag(Context context, zabe zabeVar, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map map, ClientSettings clientSettings, Map map2, Api.AbstractClientBuilder abstractClientBuilder, ArrayList arrayList) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (client2.requiresSignIn()) {
                jVar.put((Api.AnyClientKey) entry.getKey(), client2);
            } else {
                jVar2.put((Api.AnyClientKey) entry.getKey(), client2);
            }
        }
        Preconditions.checkState(!jVar.isEmpty(), "CompositeGoogleApiClient should not be used without any APIs that require sign-in.");
        ?? jVar3 = new j(0);
        ?? jVar4 = new j(0);
        for (Api api : map2.keySet()) {
            Api.AnyClientKey zab = api.zab();
            if (jVar.containsKey(zab)) {
                jVar3.put(api, (Boolean) map2.get(api));
            } else {
                if (!jVar2.containsKey(zab)) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (jVar3.containsKey(zatVar.zaa)) {
                arrayList2.add(zatVar);
            } else {
                if (!jVar4.containsKey(zatVar.zaa)) {
                    throw new IllegalStateException("Each ClientCallbacks must have a corresponding API in the isOptionalMap");
                }
                arrayList3.add(zatVar);
            }
        }
        return new zaaa(context, zabeVar, lock, looper, googleApiAvailabilityLight, jVar, jVar2, clientSettings, abstractClientBuilder, client, arrayList2, arrayList3, jVar3, jVar4);
    }

    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i, boolean z3) {
        zaaaVar.zab.zac(i, z3);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
