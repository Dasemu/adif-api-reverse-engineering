...
public final class zabe extends GoogleApiClient implements zabz {
        ...
        try {
            ...
            try {
                if (intValue == 3 || intValue == 1) {
                    ...
                    i = intValue;
                    Preconditions.checkArgument(z3, "Illegal sign-in mode: " + i);
                    zal(i);
                    zan();
                    this.zaj.unlock();
                    return;
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final void stopAutoManage(P p) {
    ...
    */
    ...
    public final ConnectionResult blockingConnect(long j4, TimeUnit timeUnit) {
        ...
        try {
            ...
            zal(((Integer) Preconditions.checkNotNull(this.zaw)).intValue());
            this.zak.zab();
            ConnectionResult zac = ((zaca) Preconditions.checkNotNull(this.zal)).zac(j4, timeUnit);
            this.zaj.unlock();
            return zac;
        } catch (Throwable th) {
            this.zaj.unlock();
