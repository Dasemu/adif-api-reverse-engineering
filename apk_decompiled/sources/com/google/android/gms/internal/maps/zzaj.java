...
public interface zzaj extends IInterface {
    void zzA(boolean z3) throws RemoteException;

    void zzB(float f2) throws RemoteException;

    void zzC(float f2) throws RemoteException;

    boolean zzD(zzaj zzajVar) throws RemoteException;
    ...
    void zzq(boolean z3) throws RemoteException;

    void zzr(int i) throws RemoteException;

    void zzs(Cap cap) throws RemoteException;

    void zzt(boolean z3) throws RemoteException;
