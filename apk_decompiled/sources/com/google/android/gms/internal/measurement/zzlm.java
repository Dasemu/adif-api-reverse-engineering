...
public final class zzlm {
    ...
    static {
        ...
        zzc = zzlmVar3;
        zzlm zzlmVar4 = new zzlm("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(BitmapDescriptorFactory.HUE_RED));
        zzd = zzlmVar4;
        zzlm zzlmVar5 = new zzlm("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
        zze = zzlmVar5;
