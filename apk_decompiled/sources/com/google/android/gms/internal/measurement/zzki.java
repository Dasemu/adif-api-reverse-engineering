...
public abstract class zzki extends zzjq {
    ...
    public static zzki zzz(byte[] bArr, int i, int i4) {
        return new zzkf(bArr, 0, i4);
    }
    ...
    public abstract void zzd(int i, boolean z3) throws IOException;
    ...
    public abstract void zzo(int i, int i4) throws IOException;

    public abstract void zzp(int i, int i4) throws IOException;
