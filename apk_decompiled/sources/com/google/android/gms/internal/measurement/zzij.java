...
public final class zzij {
    public static int zza(int i, int i4, String str) {
        ...
        if (i < 0) {
            ...
            zza = zzil.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i4));
        }
    ...
    public static void zzc(int i, int i4, int i5) {
        if (i < 0 || i4 < i || i4 > i5) {
            throw new IndexOutOfBoundsException((i < 0 || i > i5) ? zzd(i, i5, "start index") : (i4 < 0 || i4 > i5) ? zzd(i4, i5, "end index") : zzil.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i4), Integer.valueOf(i)));
        }
    }
    ...
    private static String zzd(int i, int i4, String str) {
        ...
        if (i4 >= 0) {
            return zzil.zza("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i), Integer.valueOf(i4));
        }
        throw new IllegalArgumentException(a.l(i4, "negative size: "));
    }
}
