...
public class zzkx<MessageType extends zzlb<MessageType, BuilderType>, BuilderType extends zzkx<MessageType, BuilderType>> extends zzjj<MessageType, BuilderType> {
    ...
    public final zzkx zzaC(byte[] bArr, int i, int i4, zzkn zzknVar) throws zzll {
        if (!this.zza.zzbR()) {
            zzaI();
        }
        try {
            zzmq.zza().zzb(this.zza.getClass()).zzh(this.zza, bArr, 0, i4, new zzjn(zzknVar));
            return this;
        } catch (zzll e4) {
            throw e4;
    ...
    */
    ...
    @Override // com.google.android.gms.internal.measurement.zzjj
    public final /* bridge */ /* synthetic */ zzjj zzaw(byte[] bArr, int i, int i4) throws zzll {
        zzaC(bArr, 0, i4, zzkn.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzjj
    public final /* bridge */ /* synthetic */ zzjj zzax(byte[] bArr, int i, int i4, zzkn zzknVar) throws zzll {
        zzaC(bArr, 0, i4, zzknVar);
        return this;
    }
