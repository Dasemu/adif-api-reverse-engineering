...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzn = zza2.zzd("measurement.alarm_manager.minimum_interval", TestBuildersKt.DEFAULT_DISPATCH_TIMEOUT_MS);
        ...
        zzr = zza2.zzd("measurement.upload.refresh_blacklisted_config_interval", ManageLogosUseCaseKt.OPERATOR_LOGO_CACHE_TIMEOUT);
        ...
        zzw = zza2.zzd("measurement.sdk.attribution.cache.ttl", ManageLogosUseCaseKt.OPERATOR_LOGO_CACHE_TIMEOUT);
