...
public final class zzgv extends zzei {
    ...
    private final void zzy(zzq zzqVar, boolean z3) {
    ...
    private final void zzz(String str, boolean z3) {
    ...
    public final List zze(zzq zzqVar, boolean z3) {
        ...
        try {
            ...
            for (zzlm zzlmVar : list) {
                if (!z3 && zzlp.zzaj(zzlmVar.zzc)) {
                }
                arrayList.add(new zzlk(zzlmVar));
            }
            return arrayList;
        } catch (InterruptedException | ExecutionException e4) {
            this.zza.zzaA().zzd().zzc("Failed to get user properties. appId", zzet.zzn(zzqVar.zza), e4);
            return null;
        }
    }
    ...
    public final List zzf(String str, String str2, zzq zzqVar) {
        ...
        try {
            ...
            this.zza.zzaA().zzd().zzb("Failed to get conditional user properties", e4);
    ...
    public final List zzg(String str, String str2, String str3) {
        ...
        try {
            ...
            this.zza.zzaA().zzd().zzb("Failed to get conditional user properties as", e4);
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final List zzh(String str, String str2, boolean z3, zzq zzqVar) {
        ...
        try {
            ...
            this.zza.zzaA().zzd().zzc("Failed to query user properties. appId", zzet.zzn(zzqVar.zza), e4);
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final List zzi(String str, String str2, String str3, boolean z3) {
        ...
        try {
            ...
            this.zza.zzaA().zzd().zzc("Failed to get user properties as. appId", zzet.zzn(str), e4);
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final void zzq(long j4, String str, String str2, String str3) {
        zzx(new zzgu(this, str2, str3, str, j4));
    }
    ...
    public final byte[] zzu(zzau zzauVar, String str) {
        ...
        try {
            ...
            this.zza.zzaA().zzd().zzd("Failed to log and bundle. appId, event, error", zzet.zzn(str), this.zza.zzi().zzd(zzauVar.zza), e4);
            return null;
        }
    }
    ...
    public final /* synthetic */ void zzw(String str, Bundle bundle) {
        ...
        try {
            ...
            zzh.zzt.zzaA().zzd().zzc("Error storing default event parameters. appId", zzet.zzn(str), e4);
        }
    }
