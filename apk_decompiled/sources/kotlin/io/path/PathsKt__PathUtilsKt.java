...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    @InlineOnly
    private static final Path copyTo(Path path, Path target, boolean z3) throws IOException {
    ...
    public static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z3, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            z3 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ void forEachDirectoryEntry$default(Path path, String glob, Function1 action, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            glob = CirculationMapper.VIA_ASTERISK;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(glob, "glob");
        Intrinsics.checkNotNullParameter(action, "action");
    ...
    */
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        replace$default = StringsKt__StringsJVMKt.replace$default(obj, separator, RemoteSettings.FORWARD_SLASH_STRING, false, 4, (Object) null);
    ...
    */
    ...
    public static /* synthetic */ List listDirectoryEntries$default(Path path, String str, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            str = CirculationMapper.VIA_ASTERISK;
        }
    ...
    public static /* synthetic */ Path moveTo$default(Path path, Path target, boolean z3, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            z3 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    @SinceKotlin(version = "1.7")
    @ExperimentalPathApi
    public static final void visitFileTree(Path path, FileVisitor<Path> visitor, int i, boolean z3) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(visitor, "visitor");
        Files.walkFileTree(path, z3 ? SetsKt.setOf(FileVisitOption.FOLLOW_LINKS) : SetsKt.emptySet(), i, visitor);
    }

    public static /* synthetic */ void visitFileTree$default(Path path, FileVisitor fileVisitor, int i, boolean z3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i4 & 4) != 0) {
        ...
        visitFileTree(path, (FileVisitor<Path>) fileVisitor, i, z3);
    }
    ...
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    @InlineOnly
    private static final Path moveTo(Path path, Path target, boolean z3) throws IOException {
        CopyOption[] copyOptionArr;
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        if (z3) {
    ...
    public static /* synthetic */ void visitFileTree$default(Path path, int i, boolean z3, Function1 function1, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i4 & 2) != 0) {
        ...
        visitFileTree(path, i, z3, (Function1<? super FileVisitorBuilder, Unit>) function1);
    }
    ...
    @SinceKotlin(version = "1.7")
    @ExperimentalPathApi
    public static final void visitFileTree(Path path, int i, boolean z3, Function1<? super FileVisitorBuilder, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        visitFileTree(path, fileVisitor(builderAction), i, z3);
    }
