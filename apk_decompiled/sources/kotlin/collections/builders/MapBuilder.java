...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    public static final class KeysItr<K, V> extends Itr<K, V> implements Iterator<K>, KMutableIterator {
        ...
        public K next() {
            ...
            setIndex$kotlin_stdlib(index + 1);
            setLastIndex$kotlin_stdlib(index);
            K k4 = (K) ((MapBuilder) getMap$kotlin_stdlib()).keysArray[getLastIndex()];
            initNext$kotlin_stdlib();
            return k4;
        }
    }
    ...
    private MapBuilder(K[] kArr, V[] vArr, int[] iArr, int[] iArr2, int i, int i4) {
        this.keysArray = kArr;
    ...
    private final void compact() {
        ...
        ListBuilderKt.resetRange(this.keysArray, i5, i);
        if (vArr != null) {
    ...
    private final void removeHashAt(int removedHash) {
        ...
        do {
            ...
            if (i5 < 0) {
                ...
                int i6 = i5 - 1;
                if (((hash(this.keysArray[i6]) - removedHash) & (getHashSize() - 1)) >= i) {
    ...
    private final boolean shouldCompact(int extraCapacity) {
        ...
        int i = this.length;
        int i4 = capacity$kotlin_stdlib - i;
        int size = i - size();
        return i4 < extraCapacity && i4 + size >= extraCapacity && size >= getCapacity$kotlin_stdlib() / 4;
    }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i4 <= 0) {
                    ...
                    if (Intrinsics.areEqual(this.keysArray[i4 - 1], key)) {
                        return -i4;
                    }
                    i++;
                    if (i > coerceAtMost) {
