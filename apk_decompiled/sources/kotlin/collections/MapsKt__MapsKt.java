...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> V getOrElseNullable(Map<K, ? extends V> map, K k4, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = map.get(k4);
    ...
    public static final <K, V> V getOrPut(Map<K, V> map, K k4, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = map.get(k4);
        if (v3 != null) {
    ...
    public static <K, V> V getValue(Map<K, ? extends V> map, K k4) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    public static final <K, V> Map<K, V> minus(Map<? extends K, ? extends V> map, K k4) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @InlineOnly
    private static final <K, V> void set(Map<K, V> map, K k4, V v3) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        map.put(k4, v3);
    }
