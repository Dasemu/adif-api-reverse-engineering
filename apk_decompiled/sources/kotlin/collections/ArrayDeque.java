...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public ArrayDeque(int i) {
        ...
        if (i == 0) {
            ...
            throw new IllegalArgumentException(a.l(i, "Illegal Capacity: "));
        }
    ...
    private final boolean filterInPlace(Function1<? super E, Boolean> predicate) {
        ...
        if (!isEmpty() && this.elementData.length != 0) {
            ...
            if (i < positiveMod2) {
                ...
                positiveMod = positiveMod(i4);
                for (int i5 = 0; i5 < positiveMod2; i5++) {
                    Object[] objArr2 = this.elementData;
    ...
    public final void internalStructure$kotlin_stdlib(Function2<? super Integer, ? super Object[], Unit> structure) {
        ...
        structure.invoke(Integer.valueOf((isEmpty() || (i = this.head) < positiveMod(size() + this.head)) ? this.head : i - this.elementData.length), toArray());
    }
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (positiveMod2 < i) {
                Object[] objArr = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, i4, i, objArr.length);
                ...
                Object[] objArr5 = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto(objArr5, objArr5, i4, i, positiveMod2);
            } else {
                Object[] objArr6 = this.elementData;
                i4 += objArr6.length;
                int i5 = positiveMod2 - i;
                int length = objArr6.length - i4;
                if (length >= i5) {
                    ArraysKt___ArraysJvmKt.copyInto(objArr6, objArr6, i4, i, positiveMod2);
                } else {
                    ArraysKt___ArraysJvmKt.copyInto(objArr6, objArr6, i4, i, i + length);
                    Object[] objArr7 = this.elementData;
