...
public class MapsKt___MapsKt extends MapsKt___MapsJvmKt {
    ...
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEach(M m4, Function1<? super Map.Entry<? extends K, ? extends V>, Unit> action) {
    ...
    @SinceKotlin(version = "1.4")
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEachIndexed(M m4, Function2<? super Integer, ? super Map.Entry<? extends K, ? extends V>, Unit> action) {
        Intrinsics.checkNotNullParameter(m4, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        Iterator<T> it = m4.entrySet().iterator();
        int i = 0;
        while (it.hasNext()) {
            j jVar = (Object) it.next();
            int i4 = i + 1;
            if (i < 0) {
                CollectionsKt__CollectionsKt.throwIndexOverflow();
            }
            action.invoke(Integer.valueOf(i), jVar);
            i = i4;
        }
        return m4;
    }
