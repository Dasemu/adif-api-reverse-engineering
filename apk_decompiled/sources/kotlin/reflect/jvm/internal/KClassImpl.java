...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
        ...
        public Data() {
            ...
            this.objectInstance = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<T>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$objectInstance$2
                ...
                public final T invoke() {
                    ...
                    T t2 = (T) ((!descriptor.isCompanionObject() || CompanionObjectMappingUtilsKt.isMappedIntrinsicCompanionObject(CompanionObjectMapping.INSTANCE, descriptor)) ? r2.getJClass().getDeclaredField("INSTANCE") : r2.getJClass().getEnclosingClass().getDeclaredField(descriptor.getName().asString())).get(null);
                    Intrinsics.checkNotNull(t2, "null cannot be cast to non-null type T of kotlin.reflect.jvm.internal.KClassImpl");
                    return t2;
                }
            });
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo1395getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1395getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo1395getSupertypes, "getSupertypes(...)");
                    ArrayList arrayList = new ArrayList(mo1395getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo1395getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                int indexOf;
                                ClassifierDescriptor mo1394getDeclarationDescriptor = KotlinType.this.getConstructor().mo1394getDeclarationDescriptor();
                                if (mo1394getDeclarationDescriptor instanceof ClassDescriptor) {
                                    ...
                                    if (javaClass != null) {
                                        ...
                                        indexOf = ArraysKt___ArraysKt.indexOf((Class<?>[]) ((Class[]) interfaces), javaClass);
                                        if (indexOf >= 0) {
                                            Type type = kClassImpl.getJClass().getGenericInterfaces()[indexOf];
                                            Intrinsics.checkNotNull(type);
                                            return type;
                                        }
                                        throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo1394getDeclarationDescriptor);
                                    }
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo1394getDeclarationDescriptor);
                                }
                                throw new KotlinReflectionInternalError("Supertype not a class: " + mo1394getDeclarationDescriptor);
                            }
                        }));
                    }
    ...
    private final ClassDescriptor createSyntheticClass(ClassId classId, RuntimeModuleData moduleData) {
        ...
        final ClassDescriptorImpl classDescriptorImpl = new ClassDescriptorImpl(new EmptyPackageFragmentDescriptor(module, packageFqName), classId.getShortClassName(), Modality.FINAL, ClassKind.CLASS, kotlin.collections.CollectionsKt.listOf(moduleData.getModule().getBuiltIns().getAny().getDefaultType()), SourceElement.NO_SOURCE, false, moduleData.getDeserialization().getStorageManager());
