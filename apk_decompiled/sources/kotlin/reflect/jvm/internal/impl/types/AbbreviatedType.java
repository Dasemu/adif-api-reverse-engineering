...
public final class AbbreviatedType extends DelegatingSimpleType {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.UnwrappedType
    public AbbreviatedType makeNullableAsSpecified(boolean z3) {
        return new AbbreviatedType(getDelegate().makeNullableAsSpecified(z3), this.abbreviation.makeNullableAsSpecified(z3));
    }
