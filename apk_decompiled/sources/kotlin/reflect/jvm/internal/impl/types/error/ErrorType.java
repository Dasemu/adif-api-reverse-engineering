...
public final class ErrorType extends SimpleType {
    ...
    public /* synthetic */ ErrorType(TypeConstructor typeConstructor, MemberScope memberScope, ErrorTypeKind errorTypeKind, List list, boolean z3, String[] strArr, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(typeConstructor, memberScope, errorTypeKind, (i & 8) != 0 ? CollectionsKt.emptyList() : list, (i & 16) != 0 ? false : z3, strArr);
    }
    ...
    public SimpleType makeNullableAsSpecified(boolean z3) {
        ...
        String[] strArr = this.formatParams;
        return new ErrorType(constructor, memberScope, errorTypeKind, arguments, z3, (String[]) Arrays.copyOf(strArr, strArr.length));
    }
    ...
    public ErrorType(TypeConstructor constructor, MemberScope memberScope, ErrorTypeKind kind, List<? extends TypeProjection> arguments, boolean z3, String... formatParams) {
        ...
        this.debugMessage = w.s(copyOf, copyOf.length, debugMessage, "format(...)");
    }
}
