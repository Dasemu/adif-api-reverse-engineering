...
public final class SimpleTypeWithEnhancement extends DelegatingSimpleType implements TypeWithEnhancement {
    ...
    public SimpleType makeNullableAsSpecified(boolean z3) {
        UnwrappedType wrapEnhancement = TypeWithEnhancementKt.wrapEnhancement(getOrigin().makeNullableAsSpecified(z3), getEnhancement().unwrap().makeNullableAsSpecified(z3));
