...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    public final class ModuleViewTypeConstructor implements TypeConstructor {
        ...
        public ModuleViewTypeConstructor(final AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            ...
            this.refinedSupertypes$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<List<? extends KotlinType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$ModuleViewTypeConstructor$refinedSupertypes$2
                ...
                public final List<? extends KotlinType> invoke() {
                    ...
                    return KotlinTypeRefinerKt.refineTypes(kotlinTypeRefiner2, abstractTypeConstructor.mo1395getSupertypes());
                }
            });
        }
        ...
        public ClassifierDescriptor mo1394getDeclarationDescriptor() {
            return this.this$0.mo1394getDeclarationDescriptor();
        }
        ...
        public List<KotlinType> mo1395getSupertypes() {
    ...
    public AbstractTypeConstructor(StorageManager storageManager) {
        ...
        this.supertypes = storageManager.createLazyValueWithPostCompute(new Function0<Supertypes>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$supertypes$1
            ...
            public final AbstractTypeConstructor.Supertypes invoke(boolean z3) {
    ...
    public final Collection<KotlinType> computeNeighbours(TypeConstructor typeConstructor, boolean z3) {
        List plus;
        AbstractTypeConstructor abstractTypeConstructor = typeConstructor instanceof AbstractTypeConstructor ? (AbstractTypeConstructor) typeConstructor : null;
        if (abstractTypeConstructor != null && (plus = CollectionsKt.plus((Collection) abstractTypeConstructor.supertypes.invoke().getAllSupertypes(), (Iterable) abstractTypeConstructor.getAdditionalNeighboursInSupertypeGraph(z3))) != null) {
            return plus;
        }
        Collection<KotlinType> mo1395getSupertypes = typeConstructor.mo1395getSupertypes();
