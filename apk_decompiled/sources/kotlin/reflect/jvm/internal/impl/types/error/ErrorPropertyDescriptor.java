...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public CallableMemberDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z3) {
        return this.$$delegate_0.copy(declarationDescriptor, modality, descriptorVisibility, kind, z3);
    }
    ...
    public ConstantValue<?> mo1390getCompileTimeInitializer() {
        return this.$$delegate_0.mo1390getCompileTimeInitializer();
    }
