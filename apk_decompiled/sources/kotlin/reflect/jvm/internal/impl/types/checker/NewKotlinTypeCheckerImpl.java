...
public final class NewKotlinTypeCheckerImpl implements NewKotlinTypeChecker {
    ...
    public boolean equalTypes(KotlinType a2, KotlinType b4) {
        Intrinsics.checkNotNullParameter(a2, "a");
        Intrinsics.checkNotNullParameter(b4, "b");
        return equalTypes(ClassicTypeCheckerStateKt.createClassicTypeCheckerState$default(false, false, null, getKotlinTypePreparator(), getKotlinTypeRefiner(), 6, null), a2.unwrap(), b4.unwrap());
    }
    ...
    public final boolean equalTypes(TypeCheckerState typeCheckerState, UnwrappedType a2, UnwrappedType b4) {
        Intrinsics.checkNotNullParameter(typeCheckerState, "<this>");
        Intrinsics.checkNotNullParameter(a2, "a");
        Intrinsics.checkNotNullParameter(b4, "b");
        return AbstractTypeChecker.INSTANCE.equalTypes(typeCheckerState, a2, b4);
    }
