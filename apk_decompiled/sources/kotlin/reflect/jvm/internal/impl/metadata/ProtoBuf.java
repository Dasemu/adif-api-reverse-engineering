...
public final class ProtoBuf {
    ...
    public static final class Annotation extends GeneratedMessageLite implements AnnotationOrBuilder {
            ...
            public static final class Value extends GeneratedMessageLite implements ValueOrBuilder {
                ...
                public int getSerializedSize() {
                    ...
                    for (int i4 = 0; i4 < this.arrayElement_.size(); i4++) {
                        computeEnumSize += CodedOutputStream.computeMessageSize(9, this.arrayElement_.get(i4));
                    }
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.argument_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(2, this.argument_.get(i4));
            }
            int size = this.unknownFields.size() + computeInt32Size;
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.supertypeId_.size(); i5++) {
                i4 += CodedOutputStream.computeInt32SizeNoTag(this.supertypeId_.get(i5).intValue());
            }
            ...
            if ((this.bitField0_ & 2) == 2) {
                i6 += CodedOutputStream.computeInt32Size(3, this.fqName_);
            }
            if ((this.bitField0_ & 4) == 4) {
                i6 += CodedOutputStream.computeInt32Size(4, this.companionObjectName_);
            }
            for (int i7 = 0; i7 < this.typeParameter_.size(); i7++) {
                i6 += CodedOutputStream.computeMessageSize(5, this.typeParameter_.get(i7));
            }
            for (int i8 = 0; i8 < this.supertype_.size(); i8++) {
                i6 += CodedOutputStream.computeMessageSize(6, this.supertype_.get(i8));
            }
            int i9 = 0;
            for (int i10 = 0; i10 < this.nestedClassName_.size(); i10++) {
                i9 += CodedOutputStream.computeInt32SizeNoTag(this.nestedClassName_.get(i10).intValue());
            }
            int i11 = i6 + i9;
            ...
            if ((this.bitField0_ & 8) == 8) {
                i19 += CodedOutputStream.computeInt32Size(17, this.inlineClassUnderlyingPropertyName_);
            }
            if ((this.bitField0_ & 16) == 16) {
                i19 += CodedOutputStream.computeMessageSize(18, this.inlineClassUnderlyingType_);
            }
            if ((this.bitField0_ & 32) == 32) {
                i19 += CodedOutputStream.computeInt32Size(19, this.inlineClassUnderlyingTypeId_);
            }
            for (int i20 = 0; i20 < this.contextReceiverType_.size(); i20++) {
                i19 += CodedOutputStream.computeMessageSize(20, this.contextReceiverType_.get(i20));
            }
            int i21 = 0;
            for (int i22 = 0; i22 < this.contextReceiverTypeId_.size(); i22++) {
                i21 += CodedOutputStream.computeInt32SizeNoTag(this.contextReceiverTypeId_.get(i22).intValue());
            }
            int i23 = i19 + i21;
            ...
            for (int i25 = 0; i25 < this.multiFieldValueClassUnderlyingName_.size(); i25++) {
                i24 += CodedOutputStream.computeInt32SizeNoTag(this.multiFieldValueClassUnderlyingName_.get(i25).intValue());
            }
            int i26 = i23 + i24;
            ...
            for (int i27 = 0; i27 < this.multiFieldValueClassUnderlyingType_.size(); i27++) {
                i26 += CodedOutputStream.computeMessageSize(23, this.multiFieldValueClassUnderlyingType_.get(i27));
            }
            int i28 = 0;
            for (int i29 = 0; i29 < this.multiFieldValueClassUnderlyingTypeId_.size(); i29++) {
                i28 += CodedOutputStream.computeInt32SizeNoTag(this.multiFieldValueClassUnderlyingTypeId_.get(i29).intValue());
            }
            int i30 = i26 + i28;
            ...
            if ((this.bitField0_ & 64) == 64) {
                i30 += CodedOutputStream.computeMessageSize(30, this.typeTable_);
            }
            int i31 = 0;
            for (int i32 = 0; i32 < this.versionRequirement_.size(); i32++) {
                i31 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i32).intValue());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.typeParameter_.size(); i4++) {
                codedOutputStream.writeMessage(5, this.typeParameter_.get(i4));
            }
            for (int i5 = 0; i5 < this.supertype_.size(); i5++) {
                codedOutputStream.writeMessage(6, this.supertype_.get(i5));
            }
            ...
            for (int i6 = 0; i6 < this.nestedClassName_.size(); i6++) {
                codedOutputStream.writeInt32NoTag(this.nestedClassName_.get(i6).intValue());
            }
            for (int i7 = 0; i7 < this.constructor_.size(); i7++) {
                codedOutputStream.writeMessage(8, this.constructor_.get(i7));
            }
            for (int i8 = 0; i8 < this.function_.size(); i8++) {
                codedOutputStream.writeMessage(9, this.function_.get(i8));
            }
            for (int i9 = 0; i9 < this.property_.size(); i9++) {
                codedOutputStream.writeMessage(10, this.property_.get(i9));
            }
            for (int i10 = 0; i10 < this.typeAlias_.size(); i10++) {
                codedOutputStream.writeMessage(11, this.typeAlias_.get(i10));
            }
            for (int i11 = 0; i11 < this.enumEntry_.size(); i11++) {
                codedOutputStream.writeMessage(13, this.enumEntry_.get(i11));
            }
            ...
            for (int i12 = 0; i12 < this.sealedSubclassFqName_.size(); i12++) {
                codedOutputStream.writeInt32NoTag(this.sealedSubclassFqName_.get(i12).intValue());
            }
            if ((this.bitField0_ & 8) == 8) {
            ...
            for (int i13 = 0; i13 < this.contextReceiverType_.size(); i13++) {
                codedOutputStream.writeMessage(20, this.contextReceiverType_.get(i13));
            }
            ...
            for (int i15 = 0; i15 < this.multiFieldValueClassUnderlyingName_.size(); i15++) {
                codedOutputStream.writeInt32NoTag(this.multiFieldValueClassUnderlyingName_.get(i15).intValue());
            }
            for (int i16 = 0; i16 < this.multiFieldValueClassUnderlyingType_.size(); i16++) {
                codedOutputStream.writeMessage(23, this.multiFieldValueClassUnderlyingType_.get(i16));
            }
            ...
            for (int i17 = 0; i17 < this.multiFieldValueClassUnderlyingTypeId_.size(); i17++) {
                codedOutputStream.writeInt32NoTag(this.multiFieldValueClassUnderlyingTypeId_.get(i17).intValue());
            }
            if ((this.bitField0_ & 64) == 64) {
                        ...
                        try {
                            ...
                            switch (readTag) {
                                ...
                                case 58:
                                    ...
                                    c4 = c4;
                                case 66:
                                    int i9 = (c4 == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i9 != 512) {
                                ...
                                case 82:
                                    ...
                                    c4 = c4;
                                case 90:
                                    int i12 = (c4 == true ? 1 : 0) & ConstantsKt.DEFAULT_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i12 != 4096) {
                                ...
                                case 176:
                                    ...
                                    if (i19 != 262144) {
                                        ...
                                        c4 = (c4 == true ? 1 : 0) | CharCompanionObject.MIN_VALUE;
                                    }
                                ...
                                case 258:
                                    try {
                                        ...
                                        if (((c4 == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE) == 512) {
                                            this.constructor_ = Collections.unmodifiableList(this.constructor_);
                                        }
                                        ...
                                        if (((c4 == true ? 1 : 0) & ConstantsKt.DEFAULT_BLOCK_SIZE) == 4096) {
                                            this.typeAlias_ = Collections.unmodifiableList(this.typeAlias_);
                                        }
    ...
    public static final class Constructor extends GeneratedMessageLite.ExtendableMessage<Constructor> implements ConstructorOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.valueParameter_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(2, this.valueParameter_.get(i4));
            }
            int i5 = 0;
            for (int i6 = 0; i6 < this.versionRequirement_.size(); i6++) {
                i5 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i6).intValue());
            }
            int size = this.unknownFields.size() + extensionsSerializedSize() + (getVersionRequirementList().size() * 2) + computeInt32Size + i5;
            this.memoizedSerializedSize = size;
            return size;
        }
    ...
    public static final class Contract extends GeneratedMessageLite implements ContractOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.effect_.size(); i5++) {
                i4 += CodedOutputStream.computeMessageSize(1, this.effect_.get(i5));
            }
    ...
    public static final class Effect extends GeneratedMessageLite implements EffectOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.effectConstructorArgument_.size(); i4++) {
                computeEnumSize += CodedOutputStream.computeMessageSize(2, this.effectConstructorArgument_.get(i4));
            }
            if ((this.bitField0_ & 2) == 2) {
    ...
    public static final class Expression extends GeneratedMessageLite implements ExpressionOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.andArgument_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(6, this.andArgument_.get(i4));
            }
            for (int i5 = 0; i5 < this.orArgument_.size(); i5++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(7, this.orArgument_.get(i5));
            }
            int size = this.unknownFields.size() + computeInt32Size;
            this.memoizedSerializedSize = size;
            return size;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.orArgument_.size(); i4++) {
                codedOutputStream.writeMessage(7, this.orArgument_.get(i4));
            }
            codedOutputStream.writeRawBytes(this.unknownFields);
        }
    ...
    public static final class Function extends GeneratedMessageLite.ExtendableMessage<Function> implements FunctionOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.typeParameter_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(4, this.typeParameter_.get(i4));
            }
            if ((this.bitField0_ & 32) == 32) {
                computeInt32Size += CodedOutputStream.computeMessageSize(5, this.receiverType_);
            }
            for (int i5 = 0; i5 < this.valueParameter_.size(); i5++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(6, this.valueParameter_.get(i5));
            }
            if ((this.bitField0_ & 16) == 16) {
            ...
            for (int i6 = 0; i6 < this.contextReceiverType_.size(); i6++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(10, this.contextReceiverType_.get(i6));
            }
            int i7 = 0;
            for (int i8 = 0; i8 < this.contextReceiverTypeId_.size(); i8++) {
                i7 += CodedOutputStream.computeInt32SizeNoTag(this.contextReceiverTypeId_.get(i8).intValue());
            }
            ...
            int size = (getVersionRequirementList().size() * 2) + i9 + i10;
            if ((this.bitField0_ & 256) == 256) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.valueParameter_.size(); i4++) {
                codedOutputStream.writeMessage(6, this.valueParameter_.get(i4));
            }
            if ((this.bitField0_ & 16) == 16) {
            ...
            for (int i5 = 0; i5 < this.contextReceiverType_.size(); i5++) {
                codedOutputStream.writeMessage(10, this.contextReceiverType_.get(i5));
            }
            if (getContextReceiverTypeIdList().size() > 0) {
            ...
            for (int i6 = 0; i6 < this.contextReceiverTypeId_.size(); i6++) {
                codedOutputStream.writeInt32NoTag(this.contextReceiverTypeId_.get(i6).intValue());
            }
            if ((this.bitField0_ & 128) == 128) {
                codedOutputStream.writeMessage(30, this.typeTable_);
            }
                        ...
                        try {
                            ...
                            switch (readTag) {
                                ...
                                case 82:
                                    ...
                                    this.contextReceiverType_.add(codedInputStream.readMessage(Type.PARSER, extensionRegistryLite));
                                case 88:
                                    int i6 = (c4 == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i6 != 512) {
                                        this.contextReceiverTypeId_ = new ArrayList();
                                        c4 = (c4 == true ? 1 : 0) | 512;
                                ...
                                case 90:
                                    int pushLimit = codedInputStream.pushLimit(codedInputStream.readRawVarint32());
                                    int i7 = (c4 == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i7 != 512) {
                                        c4 = c4;
                                        if (codedInputStream.getBytesUntilLimit() > 0) {
                                ...
                                case 242:
                                    ...
                                    this.bitField0_ |= 128;
                                case 248:
                                    int i8 = (c4 == true ? 1 : 0) & ConstantsKt.DEFAULT_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i8 != 4096) {
                                        this.versionRequirement_ = new ArrayList();
                                        c4 = (c4 == true ? 1 : 0) | 4096;
                                ...
                                case 250:
                                    int pushLimit2 = codedInputStream.pushLimit(codedInputStream.readRawVarint32());
                                    int i9 = (c4 == true ? 1 : 0) & ConstantsKt.DEFAULT_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i9 != 4096) {
                                        c4 = c4;
                                        if (codedInputStream.getBytesUntilLimit() > 0) {
    ...
    public static final class Package extends GeneratedMessageLite.ExtendableMessage<Package> implements PackageOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.function_.size(); i5++) {
                i4 += CodedOutputStream.computeMessageSize(3, this.function_.get(i5));
            }
            for (int i6 = 0; i6 < this.property_.size(); i6++) {
                i4 += CodedOutputStream.computeMessageSize(4, this.property_.get(i6));
            }
            for (int i7 = 0; i7 < this.typeAlias_.size(); i7++) {
                i4 += CodedOutputStream.computeMessageSize(5, this.typeAlias_.get(i7));
            }
            if ((this.bitField0_ & 1) == 1) {
                i4 += CodedOutputStream.computeMessageSize(30, this.typeTable_);
            }
            if ((this.bitField0_ & 2) == 2) {
                i4 += CodedOutputStream.computeMessageSize(32, this.versionRequirementTable_);
            }
            int size = this.unknownFields.size() + extensionsSerializedSize() + i4;
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.property_.size(); i4++) {
                codedOutputStream.writeMessage(4, this.property_.get(i4));
            }
            for (int i5 = 0; i5 < this.typeAlias_.size(); i5++) {
                codedOutputStream.writeMessage(5, this.typeAlias_.get(i5));
            }
            if ((this.bitField0_ & 1) == 1) {
                codedOutputStream.writeMessage(30, this.typeTable_);
            }
    ...
    public static final class PackageFragment extends GeneratedMessageLite.ExtendableMessage<PackageFragment> implements PackageFragmentOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.class__.size(); i4++) {
                computeMessageSize += CodedOutputStream.computeMessageSize(4, this.class__.get(i4));
            }
    ...
    public static final class Property extends GeneratedMessageLite.ExtendableMessage<Property> implements PropertyOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.contextReceiverType_.size(); i5++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(12, this.contextReceiverType_.get(i5));
            }
            int i6 = 0;
            ...
            int size = this.unknownFields.size() + extensionsSerializedSize() + (getVersionRequirementList().size() * 2) + i8 + i9;
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.contextReceiverType_.size(); i4++) {
                codedOutputStream.writeMessage(12, this.contextReceiverType_.get(i4));
            }
            if (getContextReceiverTypeIdList().size() > 0) {
            ...
            for (int i5 = 0; i5 < this.contextReceiverTypeId_.size(); i5++) {
                codedOutputStream.writeInt32NoTag(this.contextReceiverTypeId_.get(i5).intValue());
            }
            for (int i6 = 0; i6 < this.versionRequirement_.size(); i6++) {
                        ...
                        try {
                            ...
                            switch (readTag) {
                                ...
                                case 98:
                                    ...
                                    this.contextReceiverType_.add(codedInputStream.readMessage(Type.PARSER, extensionRegistryLite));
                                case 104:
                                    int i5 = (c4 == true ? 1 : 0) & ConstantsKt.MINIMUM_BLOCK_SIZE;
                                    c4 = c4;
                                    if (i5 != 512) {
                                        this.contextReceiverTypeId_ = new ArrayList();
                                        c4 = (c4 == true ? 1 : 0) | 512;
    ...
    public static final class QualifiedNameTable extends GeneratedMessageLite implements QualifiedNameTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.qualifiedName_.size(); i5++) {
                i4 += CodedOutputStream.computeMessageSize(1, this.qualifiedName_.get(i5));
            }
            int size = this.unknownFields.size() + i4;
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class StringTable extends GeneratedMessageLite implements StringTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.string_.size(); i5++) {
                i4 += CodedOutputStream.computeBytesSizeNoTag(this.string_.getByteString(i5));
            }
            int size = this.unknownFields.size() + getStringList().size() + i4;
            this.memoizedSerializedSize = size;
            return size;
        }
    ...
    public static final class Type extends GeneratedMessageLite.ExtendableMessage<Type> implements TypeOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            int computeInt32Size = (this.bitField0_ & ConstantsKt.DEFAULT_BLOCK_SIZE) == 4096 ? CodedOutputStream.computeInt32Size(1, this.flags_) : 0;
            for (int i4 = 0; i4 < this.argument_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(2, this.argument_.get(i4));
            }
            if ((this.bitField0_ & 1) == 1) {
    ...
    public static final class TypeAlias extends GeneratedMessageLite.ExtendableMessage<TypeAlias> implements TypeAliasOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.typeParameter_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(3, this.typeParameter_.get(i4));
            }
            if ((this.bitField0_ & 4) == 4) {
            ...
            for (int i5 = 0; i5 < this.annotation_.size(); i5++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(8, this.annotation_.get(i5));
            }
            int i6 = 0;
            for (int i7 = 0; i7 < this.versionRequirement_.size(); i7++) {
                i6 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i7).intValue());
            }
            int size = this.unknownFields.size() + extensionsSerializedSize() + (getVersionRequirementList().size() * 2) + computeInt32Size + i6;
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.annotation_.size(); i4++) {
                codedOutputStream.writeMessage(8, this.annotation_.get(i4));
            }
    ...
    public static final class TypeParameter extends GeneratedMessageLite.ExtendableMessage<TypeParameter> implements TypeParameterOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.upperBound_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(5, this.upperBound_.get(i4));
            }
            int i5 = 0;
            for (int i6 = 0; i6 < this.upperBoundId_.size(); i6++) {
                i5 += CodedOutputStream.computeInt32SizeNoTag(this.upperBoundId_.get(i6).intValue());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.upperBoundId_.size(); i4++) {
                codedOutputStream.writeInt32NoTag(this.upperBoundId_.get(i4).intValue());
            }
    ...
    public static final class TypeTable extends GeneratedMessageLite implements TypeTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.type_.size(); i5++) {
                i4 += CodedOutputStream.computeMessageSize(1, this.type_.get(i5));
            }
            if ((this.bitField0_ & 1) == 1) {
                i4 += CodedOutputStream.computeInt32Size(2, this.firstNullable_);
            }
            int size = this.unknownFields.size() + i4;
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class VersionRequirementTable extends GeneratedMessageLite implements VersionRequirementTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.requirement_.size(); i5++) {
                i4 += CodedOutputStream.computeMessageSize(1, this.requirement_.get(i5));
            }
            int size = this.unknownFields.size() + i4;
            this.memoizedSerializedSize = size;
            return size;
