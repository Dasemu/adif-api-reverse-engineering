    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements StringTableTypesOrBuilder {
        ...
        public static final class Record extends GeneratedMessageLite implements RecordOrBuilder {
            ...
            public int getSerializedSize() {
                ...
                for (int i5 = 0; i5 < this.substringIndex_.size(); i5++) {
                    i4 += CodedOutputStream.computeInt32SizeNoTag(this.substringIndex_.get(i5).intValue());
                }
                ...
                for (int i8 = 0; i8 < this.replaceChar_.size(); i8++) {
                    i7 += CodedOutputStream.computeInt32SizeNoTag(this.replaceChar_.get(i8).intValue());
                }
                int i9 = i6 + i7;
                ...
                if ((this.bitField0_ & 4) == 4) {
                    i9 += CodedOutputStream.computeBytesSize(6, getStringBytes());
                }
            ...
            public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
                ...
                for (int i4 = 0; i4 < this.replaceChar_.size(); i4++) {
                    codedOutputStream.writeInt32NoTag(this.replaceChar_.get(i4).intValue());
                }
                if ((this.bitField0_ & 4) == 4) {
        ...
        public int getSerializedSize() {
            ...
            for (int i5 = 0; i5 < this.record_.size(); i5++) {
                i4 += CodedOutputStream.computeMessageSize(1, this.record_.get(i5));
            }
            int i6 = 0;
            for (int i7 = 0; i7 < this.localName_.size(); i7++) {
                i6 += CodedOutputStream.computeInt32SizeNoTag(this.localName_.get(i7).intValue());
            }
            int i8 = i4 + i6;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.localName_.size(); i4++) {
                codedOutputStream.writeInt32NoTag(this.localName_.get(i4).intValue());
            }
            codedOutputStream.writeRawBytes(this.unknownFields);
        }
