...
public final class MethodSignatureMappingKt {
    ...
    public static final String computeJvmDescriptor(FunctionDescriptor functionDescriptor, boolean z3, boolean z4) {
        String asString;
    ...
    public static /* synthetic */ String computeJvmDescriptor$default(FunctionDescriptor functionDescriptor, boolean z3, boolean z4, int i, Object obj) {
        if ((i & 1) != 0) {
            z3 = true;
        }
        if ((i & 2) != 0) {
        ...
        return computeJvmDescriptor(functionDescriptor, z3, z4);
    }
