...
public class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(D d4, Set<D> set) {
        if (d4 == null) {
            $$$reportNull$$$0(73);
        }
        if (set == 0) {
        ...
        Iterator<? extends CallableDescriptor> it = d4.getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(D d4) {
        if (d4 == null) {
            $$$reportNull$$$0(71);
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        collectAllOverriddenDescriptors(d4.getOriginal(), linkedHashSet);
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo1394getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo1394getDeclarationDescriptor);
    }
    ...
    public static DescriptorVisibility getDefaultConstructorVisibility(ClassDescriptor classDescriptor, boolean z3) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo1395getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = mo1394getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo1395getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(D d4) {
        if (d4 == null) {
            $$$reportNull$$$0(59);
        }
        while (d4.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            Collection<? extends CallableMemberDescriptor> overriddenDescriptors = d4.getOverriddenDescriptors();
            if (overriddenDescriptors.isEmpty()) {
                throw new IllegalStateException("Fake override should have at least one overridden descriptor: " + d4);
            }
            d4 = (D) overriddenDescriptors.iterator().next();
        }
        return d4;
    }

    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(D d4) {
        if (d4 == null) {
            $$$reportNull$$$0(64);
        }
        if (d4 instanceof CallableMemberDescriptor) {
            return unwrapFakeOverride((CallableMemberDescriptor) d4);
        }
        if (d4 == null) {
            $$$reportNull$$$0(65);
        }
    ...
    public static <D extends DeclarationDescriptor> D getParentOfType(DeclarationDescriptor declarationDescriptor, Class<D> cls, boolean z3) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
