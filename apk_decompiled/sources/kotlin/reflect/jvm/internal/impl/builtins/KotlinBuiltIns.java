...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor mo1396getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1396getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (mo1396getContributedClassifier != null) {
                    ...
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo1396getContributedClassifier);
                }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo1394getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1394getDeclarationDescriptor = kotlinType.getConstructor().mo1394getDeclarationDescriptor();
        return (mo1394getDeclarationDescriptor == null || getPrimitiveArrayType(mo1394getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1394getDeclarationDescriptor = kotlinType.getConstructor().mo1394getDeclarationDescriptor();
        return (mo1394getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo1394getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo1394getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo1394getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public void createBuiltInsModule(boolean z3) {
        ...
        moduleDescriptorImpl.initialize(BuiltInsLoader.Companion.getInstance().createPackageFragmentProvider(this.storageManager, this.builtInsModule, getClassDescriptorFactories(), getPlatformDependentDeclarationFilter(), getAdditionalClassPartsProvider(), z3));
