...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return m119exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(m119exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r4) {
        return Result.m122isFailureimpl(obj) ? r4 : obj;
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m123isSuccessimpl(obj) ? Result.m116constructorimpl(transform.invoke(obj)) : Result.m116constructorimpl(obj);
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable m119exceptionOrNullimpl = Result.m119exceptionOrNullimpl(obj);
        return m119exceptionOrNullimpl == null ? obj : Result.m116constructorimpl(transform.invoke(m119exceptionOrNullimpl));
    }
    ...
    private static final <T, R> Object runCatching(T t2, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m116constructorimpl(block.invoke(t2));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m116constructorimpl(createFailure(th));
        }
